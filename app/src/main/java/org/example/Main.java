...
public class Main {
    ...
    private static void usage() {
        ...
        System.out.println("  benchmark-run: Run all algorithms against the graphs");
        System.out.println("  === Draw Algorithm");
        System.out.println("  draw-astar GRAPHNAME : execute A* on GRAPHNAME");
        System.out.println("  draw-dijkstra GRAPHNAME : execute dijkstra on GRAPHNAME");
        System.out.println("  draw-jps GRAPHNAME : execute JPS on GRAPHNAME");
        System.out.println("  draw-quadtree GRAPHNAME : execute quadtree on GRAPHNAME");
        ...
        System.out.println("  benchmark-run3d: Run all algorithms against the graphs");
        System.out.println("  === Draw Algorithm");
